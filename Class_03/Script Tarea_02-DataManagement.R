...
Chile$income1000<-Chile$income/1000 #Crear la nueva variable de una forma diferente
...
Chile2[age<=65, Viejitos:=0]

Chile2

# 9. Cree un nuevo objeto que muestre los valores promedio de ingreso y edad por region y sexo
#     Nota: Si tiene observaciones con NA, por qué es esto? Cómo lo arreglamos? --> SE PONE PUNTO PARA HACER UNA LISTA DE VARIABLES 
